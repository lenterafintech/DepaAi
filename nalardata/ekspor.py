...
from nalardata.keranjang import Keranjang
from nalardata.narrative import AUDIENCE_LABELS, AUDIENCES, Laporan, tabel_markdown
from nalardata.report_html import laporan_html, laporan_html_semua
from nalardata.sintaks import bangkitkan
...
def susun_blok(laporan: Laporan, pembaca: str = "eksekutif", lengkap: bool = False) -> list[Blok]:
    ...
    blok.append(
        Blok(
            "catatan",
            catatan=(
                "Disusun otomatis oleh NalarData. Kesimpulan statistik menunjukkan pola "
...
def _grafik(laporan: Laporan) -> list[tuple[str, bytes]]:
    ...
    try:
        from nalardata.grafik import grafik_laporan
