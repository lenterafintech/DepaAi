...
def render(df, kamus, penelitian) -> None:
    if not ui.butuh_fitur("entri_data"):
        return
        ...
        if rapi.empty:
            ...
            if simpan.button("Jadikan data aktif", type="primary", width="stretch"):
                ...
                st.success(
                    ...
                    "Seluruh tab analisis kini memakai data ini."
                )
                st.rerun()
    ...
    with tab_sunting:
        ...
        if aktif is None:
            ...
            if st.button("Simpan perubahan ke data aktif", type="primary", key="simpan_sunting"):
                ...
                st.success("Perubahan disimpan. Tab analisis akan memakai data terbaru.")
                st.rerun()
    ...
    with tab_gabung:
        ...
        if aktif_g is None or aktif_g.empty:
            st.info(
                "Belum ada data aktif. Muat data pada sub-tab *Muat Data*, atau buat "
            ...
            if len(angka_g) < 2:
                ...
                try:
                    ...
                    if st.button(
                        ...
                        st.success(
                            f"Variabel **{gabungan.name}** ditambahkan. Seluruh tab "
